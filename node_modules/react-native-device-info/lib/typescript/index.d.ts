...
export declare function getPowerState(): Promise<PowerState | {}>;
...
export declare function getAvailableLocationProviders(): Promise<LocationProviderInfo>;
export declare function getAvailableLocationProvidersSync(): LocationProviderInfo;
